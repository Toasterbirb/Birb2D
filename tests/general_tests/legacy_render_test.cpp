...
// TODO: Re-create this test in smaller chunks. Its a bit too bloated
// and should only test one thing at a time in contained TEST_CASEs
...
namespace BirbTest
{
	...
	//		Birb::Entity::Image testEntity("Test entity", Birb::Vector2Int(10, 10), texture);
	//		Birb::Entity::Image secondEntityWithSameTexture("Second entity with the same texture", Birb::Rect(200, 400, 128 * 2, 72 * 2), texture);
